	...
	LFD_bigMalesFemales<-LFD_bigMalesFemales[which(LFD_bigMalesFemales$Sex==2),]
	...
	while (LOGLIKE - LOGOLD > TOL)
	{
	  ...
	  BLAH <- 50:170
	  #plot(BLAH,exp(VV[1])+VV[2]*BLAH+VV[3]*BLAH^2,type='l',xlab="Mean length (mm)", ylab="Variance",lwd=2.5,ylim=c(0,400))
