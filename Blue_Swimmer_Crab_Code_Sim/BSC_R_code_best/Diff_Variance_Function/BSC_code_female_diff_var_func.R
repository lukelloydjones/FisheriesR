...
WHICH86FM <- which((YEAR == '1986') & (as.numeric(MONTHS) %in% (2:5)))
	...
	T0 <- 0.29964797   														#Initialise first seasonality parameter
	T1 <- 0.01721561														#Initialise second seasonality parameter
...
PARA[4]=165.52610821 
VV=c(10.55500843, 0.01530959, -6.77832716, 1474.95593755)
#  0.74756821    0.37731542    0.01898193  165.52610821   59.63275513   81.00951732   10.55500843    0.01530959
 #[9]   -6.77832716 1474.95593755
